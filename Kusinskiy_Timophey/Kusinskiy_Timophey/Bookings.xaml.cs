...
namespace Kusinskiy_Timophey
{
    ...
    public partial class Bookings : Window
    {
            ...
            try
            {
                ...
                || txtPhone.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new Exception("Невозможно занять 0 мест");
                        }
                    }
                }
                else
        ...
        private void ListViewBookings_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
        }
    }
}
