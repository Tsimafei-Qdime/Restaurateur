...
namespace Kusinskiy_Timophey
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                System.Windows.MessageBox.Show($"Can't load window: '{ex.Message}'", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void Calendar_SelectedDatesChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                System.Windows.MessageBox.Show($"Can't select date: '{ex.Message}'", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void btnLogOut_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            {
                System.Windows.MessageBox.Show($"Can't log out: '{ex.Message}'", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void ListViewMenu_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                System.Windows.MessageBox.Show($"Can't select dish: '{ex.Message}'", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
}
