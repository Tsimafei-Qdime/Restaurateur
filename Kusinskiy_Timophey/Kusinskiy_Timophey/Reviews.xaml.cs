...
namespace Kusinskiy_Timophey
{
    ...
    public partial class Reviews : Window
    {
        ...
        private void ListViewUsers_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show($"Can't select user: '{ex.Message}'", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        ...
        private void txtDescriptions_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
